            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
              ...
              <div className="order-2 md:order-1">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-3">
                  Descubra o script exato para transformar carrinhos abandonados
                  em vendas automáticas
                </h1>

                <p className="text-base md:text-lg text-gray-600 mb-4 max-w-xl">
                  Não deixe seus leads esfriarem na "janela de ouro". Preencha
                  os dados abaixo e receba gratuitamente nosso E-book com o
                  script e o passo a passo para configurar a recuperação de
                  compras do seu negócio.
                </p>
                ...
                <div className="bg-white rounded-2xl p-5 md:p-6 border border-gray-200 shadow-lg">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Preencha o formulário para liberar o seu script
                      gratuitamente.
                    </p>
                  </div>
                  ...
                  <div>
                    <form id="meuForm" accept-charset="UTF-8">
                      ...
                      <div className="container_html">
                        ...
                        <textarea name="popup_opening_text" className="hidden">
                          Você deu o primeiro passo para recuperar vendas
                          perdidas. Este ebook reúne estratégias comprovadas que
                          podem transformar seus resultados:
                          https://firebasestorage.googleapis.com/v0/b/followop.firebasestorage.app/o/training-files%2Fe0e572b3-8816-43ca-8b9b-603123703f25%2FBlueprint_Funil_Blindado.pdf?alt=media&token=5575d47e-a236-4347-a288-ba435d8a7b01
                        </textarea>
                        <input
                          type="hidden"
                          name="popup_opening_time"
                          value="3"
                        />
                    ...
                    {modalOpen && (
                      ...
                      >
                        ...
                        />
                        <div
                          className="relative bg-white rounded-2xl p-6 max-w-md mx-4 shadow-2xl animate-modalEntrance"
                          role="document"
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                Obrigado! Em instantes você receberá o material
                                por WhatsApp.
                              </p>
                            </div>
                          </div>
                          ...
                          <p className="text-sm text-gray-700 mb-4">
                            Enquanto isso, se quiser falar com um especialista,
                            agende uma reunião rápida. Temos disponibilidade
                            para analisar seu caso e sugerir ações imediatas.
                          </p>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-green-50 border-2 border-green-100 rounded-2xl p-6 shadow-md">
                ...
                <p className="text-gray-600">
                  Os maiores players do mercado já entenderam o jogo. Escalar
                  não é apenas trazer novos curiosos, é parar de desperdiçar
                  quem você já pagou para conquistar . Eles tapam os buracos do
                  funil e recuperam quem já demonstrou interesse. Hoje, o
                  dinheiro mais barato está nesses leads que ficaram pelo
                  caminho.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-4">
                  A conta é simples: se o seu Custo de Aquisição (CAC) não fecha
                  agora, imagina nos próximos meses. Infoprodutor que não
                  otimiza a base de leads, quebra. Simples assim.
                </p>
                <Button
        ...
        <section className="py-10 md:py-16 lg:py-20 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                4 pilares essenciais para transformar carrinhos abandonados em
                vendas
              </p>
            </div>
