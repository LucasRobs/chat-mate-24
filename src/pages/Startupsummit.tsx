      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        >
          ...
          <div className="container_html" style={{ width: '100%' }}>
            ...
            <textarea name="popup_opening_text" style={{ display: 'none' }} defaultValue="Oi {name}, vi que você já mostrou interesse.&#10;Sabia que responder um lead em até 5min aumenta em até 80% as chances de fechar? 🚀&#10;&#10;Quer que eu te mostre como a Followop faz isso automaticamente pra você?"></textarea>
