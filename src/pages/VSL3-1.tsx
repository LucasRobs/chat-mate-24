...
export default function VSL31() {
  ...
  const scrollToCalendar = () => {
    const calendarSection = document.getElementById("calendario-agendamento");
    if (calendarSection) {
    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <main>
        <section
          ...
          className="py-8 md:py-12 lg:py-16 px-4 bg-white"
        >
          <div className="container mx-auto max-w-5xl">
            <iframe
              src="https://calendar.google.com/calendar/appointments/schedules/AcZssZ2CkzF-1naILf6uGM-ROcYzlaD-GGxuWCZop1XX24pHqTddSAvCwpAC0fGkLvHFc_gH31_S6y1Z?gv=true"
              style={{ border: 0 }}
              width="100%"
              height="600"
              frameBorder="0"
