  ...
  return (
    <section id="partners" className="bg-white relative overflow-hidden animated-section">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
        <div
          className={`text-center mb-6 sm:mb-8 fade-in-up ${isVisible ? "in-view" : ""
            }`}
        >
          ...
          {partners.map((partner, index) => (
            ...
            >
              <img
                ...
                className={`h-8 sm:h-10 md:h-12 w-auto transition-all filter grayscale opacity-60 hover:opacity-80 ${partner.darkFilter ? "brightness-75" : ""
                  }`}
              />
            </div>
          ))}
