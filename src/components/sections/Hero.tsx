...
const SystemFeatures = () => (
  <div
    className="grid grid-cols-2 gap-3 max-w-2xl mt-4 mx-auto animate-fade-in px-1 sm:grid-cols-4"
    ...
    <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 sm:gap-4">
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500">
          Configure um disparo em massa para seus leads
        </p>
      </div>
    ...
    <div className="grid grid-cols-1 gap-4">
      <div className="bg-gray-50 border border-gray-100 rounded-xl p-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-3 text-xs sm:text-sm text-gray-600">
          Olá {"{nome}"}, vimos que você se interessou pelo nosso produto.
          Gostaria de tirar alguma dúvida com um de nossos especialistas?
        </div>
  ...
  <div className="space-y-3 sm:space-y-6">
    <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 sm:gap-4">
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500">
          Cadências automáticas para não perder nenhum retorno
        </p>
      </div>
      <Button
        variant="outline"
        className="hidden sm:flex text-sm h-9 border-gray-200 shadow-sm"
      >
        Novo Follow-up
      </Button>
    </div>
      ...
      <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
        ...
        <div className="w-[calc(100%-3.5rem)] md:w-[calc(50%-3rem)] bg-white p-3 sm:p-4 rounded-xl border border-gray-100 shadow-sm ml-2 md:mx-0 transition-transform hover:-translate-y-1">
          <div className="flex flex-col xl:flex-row xl:items-start justify-between mb-2 gap-1.5 sm:gap-2">
            ...
            <span className="text-[10px] px-2 py-0.5 rounded-full bg-green-50 text-green-600 font-medium whitespace-nowrap self-start">
              Imediato
            </span>
          </div>
          <p className="text-xs text-gray-500 leading-relaxed">
            Olá, vi que se cadastrou. Como posso ajudar com a sua operação de
            vendas hoje?
          </p>
        </div>
      </div>
      ...
      <div className="hidden sm:flex relative items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active mt-6">
        ...
        <div className="w-[calc(100%-3.5rem)] md:w-[calc(50%-3rem)] bg-white p-3 sm:p-4 rounded-xl border border-gray-100 shadow-sm ml-2 md:mx-0 transition-transform hover:-translate-y-1">
          <div className="flex flex-col xl:flex-row xl:items-start justify-between mb-2 gap-1.5 sm:gap-2">
            ...
            <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-50 text-blue-600 font-medium whitespace-nowrap self-start">
              Após 2 horas
            </span>
          </div>
          <p className="text-xs text-gray-500 leading-relaxed">
            Sabia que nossos clientes economizam 12h semanais automatizando as
            respostas?
          </p>
        </div>
      </div>
      ...
      <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active mt-6">
        ...
        <div className="w-[calc(100%-3.5rem)] md:w-[calc(50%-3rem)] bg-white p-3 sm:p-4 rounded-xl border border-gray-100 shadow-sm ml-2 md:mx-0 transition-transform hover:-translate-y-1">
          <div className="flex flex-col xl:flex-row xl:items-start justify-between mb-2 gap-1.5 sm:gap-2">
            ...
            <span className="text-[10px] px-2 py-0.5 rounded-full bg-amber-50 text-amber-600 font-medium whitespace-nowrap self-start">
              Dia seguinte
            </span>
          </div>
          <p className="text-xs text-gray-500 leading-relaxed">
            Sei que o tempo está corrido. Posso enviar um áudio rápido de 30s
            explicando?
          </p>
        </div>
      </div>
  ...
  <div className="space-y-2 sm:space-y-4 flex flex-col h-full">
    <div className="flex justify-between items-center shrink-0 mb-1 sm:mb-2">
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500">
          Leads sendo qualificados em tempo real
        </p>
      </div>
    </div>
    ...
    <div className="flex gap-4 overflow-x-auto pb-4 h-full snap-x snap-mandatory [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      ...
      <div className="w-[85vw] max-w-[280px] sm:max-w-none sm:w-64 shrink-0 snap-center bg-gray-50/80 rounded-xl p-3 flex flex-col border border-gray-100 h-full">
        <div className="flex justify-between items-center mb-3 px-1">
          ...
          <span className="bg-white border border-gray-200 text-gray-600 text-[10px] px-2 py-0.5 rounded-full font-medium shadow-sm">
            12
          </span>
        </div>
          ...
          >
            ...
            <div className="mt-3 bg-indigo-50/50 rounded p-1.5 flex items-start gap-1.5 ml-1 border border-indigo-100">
              ...
              <span className="text-[10px] text-indigo-700 font-medium leading-tight">
                IA Respondeu: "Qual o seu nicho de atuação principal?"
              </span>
            </div>
          </motion.div>
        </div>
        ...
        <div className="space-y-3 flex-1">
          <div className="bg-white p-3 rounded-lg border border-gray-200 shadow-sm transition-transform hover:-translate-y-0.5 cursor-pointer">
            <div className="flex justify-between items-start">
              ...
              <span className="text-[10px] font-medium text-amber-600 bg-amber-50 border border-amber-100 px-1.5 rounded">
                Andamento
              </span>
            </div>
            ...
            <div className="mt-3 text-[10px] text-gray-500 flex items-center gap-1.5 border-t border-gray-50 pt-2">
              <MessageSquare className="w-3 h-3 text-gray-400" /> 8 mensagens
              trocadas
            </div>
          </div>
        </div>
  ...
  <div className="space-y-4 sm:space-y-6">
    <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 sm:gap-4">
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500">
          Múltiplos números rodando em paralelo sem restrições
        </p>
      </div>
      ...
      <div className="bg-white border border-green-200/60 rounded-xl p-3 sm:p-4 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
        ...
        <div className="grid grid-cols-2 gap-2 text-center mt-2 border-t border-gray-50 pt-2 sm:pt-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm font-medium text-green-600 mt-1 sm:mt-1.5">
              Estável
            </p>
          </div>
        </div>
        ...
        <div className="md:w-64 bg-gray-50/40 border-b md:border-b-0 md:border-r border-gray-100 p-2 sm:p-4 grid grid-cols-2 md:flex md:flex-col gap-2 sm:gap-3 shrink-0 pb-3 md:pb-4">
          {tabs.map((tab) => (
            <button
              ...
              className={`group flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-1.5 lg:gap-3 px-2 py-2 sm:px-4 sm:py-3.5 rounded-xl text-[11px] lg:text-sm font-medium transition-all duration-200 whitespace-normal text-center lg:text-left border ${
                activeTab === tab.id
            ...
            >
              <div
                className={`${activeTab === tab.id ? "text-[#16B763]" : "text-gray-400 group-hover:text-gray-600"} shrink-0 transition-colors`}
              >
                {tab.icon}
              </div>
  ...
  return (
    <section className="relative bg-white overflow-hidden flex flex-col justify-center pt-24 pb-14 sm:pb-20 mobile-container">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div
          className={`flex justify-center ${isMobile ? "mb-6 mt-4" : "mb-8 mt-8"}`}
        >
        ...
        <div className="mx-auto flex flex-col items-center text-center gap-10">
          <div className="max-w-3xl flex flex-col items-center">
            ...
            <div
              className="mt-5 min-h-16 sm:min-h-20 md:min-h-24 blur-reveal"
              style={{ transitionDelay: "300ms", minHeight: "80px" }}
            >
              <h2
                className="max-w-xl mx-auto text-lg sm:text-2xl md:text-3xl font-light text-gray-600 animate-fade-in-down"
                style={{ animationDelay: "300ms" }}
              >
                Nunca mais perca vendas por falta de <br />
                <span className="font-medium text-[#16B763] typing-animation border-b-2 border-[#16B763]/30 pb-1">
                  {displayedText}
                </span>
              </h2>
            </div>
            ...
            <p
              className="blur-reveal mt-2 text-sm sm:text-lg text-gray-500 leading-relaxed font-light"
              style={{ transitionDelay: "500ms" }}
            >
              Um ecossistema inteligente que acaba com o trabalho braçal,
              resgata orçamentos esquecidos e assume as tarefas repetitivas.
              Escale seu atendimento e fature com previsibilidade.
            </p>

            <div
              className="mt-8 flex flex-col gap-4 blur-reveal sm:flex-row sm:items-center justify-center w-full"
            ...
            <div
              className="mt-8 w-full blur-reveal"
          ...
          <div
            className="w-full max-w-5xl mt-12 sm:mt-16 blur-reveal"
