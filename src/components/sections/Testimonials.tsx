  ...
  return (
    <section id="testimonials" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-10 transition-all duration-1000 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="relative bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-gray-100 min-h-[480px] flex flex-col justify-between"
            >
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-28 h-28 rounded-full overflow-hidden border-4 border-primary/20 mb-4">
                  <img
