...
const testimonials = [
  ...
  },
  {
    ...
    role: "Cardiologista",
    image: "/Imagem do WhatsApp de 2025-04-05 à(s) 15.11.56_684ce281.png", // Troque pelo caminho da imagem real
...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-20 bg-white relative overflow-hidden">
      {/* Background pattern com logo followop */}
