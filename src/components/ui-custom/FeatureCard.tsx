...
const FeatureCard = ({
  ...
  return (
    <div 
      className={cn(
        "bg-white/80 backdrop-blur-sm rounded-xl p-4 sm:p-5 shadow-sm border border-gray-100 text-center",
    ...
    >
      ...
      <h3 className="text-sm sm:text-base font-light text-black mb-1.5 sm:mb-2 group-hover:text-primary/90 transition-colors duration-500">{title}</h3>
      <p className="text-gray-500 font-light text-xs line-clamp-2">{description}</p>
    </div>
  );
};
